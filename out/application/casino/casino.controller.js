"use strict";
// import { MessageIn } from '../../shared/intent'
// import CasinoService from "./casino.service";
// import {Account} from "../../domain/account";
// import { AccountStore } from '../../infrastructure/store/account/account-store'
// import { MessageEmbed, User, MessageReaction, ReactionCollector } from 'discord.js'
// export default class CasinoCommand {
//   accountManager: AccountStore;
//   casino: CasinoService;
//   constructor(accountManager: AccountStore) {
//     this.accountManager = accountManager;
//     this.casino = new CasinoService();
//   }
//   doubleOrNothing(intent : MessageIn) {
//     const userId : string = intent.getUserId();
//     const user: Account | undefined = this.accountManager.load(userId);
//     const messageBot = new MessageEmbed().setColor("#F7960A").setTitle("Double OR Nothing").setThumbnail("https://i.ibb.co/TgzRW2y/IMG-20201124-121326.jpg");
